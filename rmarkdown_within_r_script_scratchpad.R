...
#' note that you need to actually run the code below from the console or a seperate r script
#' it is not intended to be the bottom line of code in this script that you are trying to knit
#' you would run just the portion of code inside the single quotes, like normal r code, no rmarkdown funny-business
#' `rmarkdown::render('C:/Users/Stephen/Desktop/R/rmarkdown/rmarkdown_within_r_script_scratchpad.R')`
